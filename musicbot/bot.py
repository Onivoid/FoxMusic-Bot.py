...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='Created by : Skullyfox#5887', icon_url='https://cdn.discordapp.com/app-icons/633471307819909120/3c4d5dcdc381d04dde6b1edabd5552ca.png?size=64')
        e.set_author(name=self.user.name, url='https://github.com/Skullyfox/FoxMusic-Bot.py', icon_url=self.user.avatar_url)
        return e
